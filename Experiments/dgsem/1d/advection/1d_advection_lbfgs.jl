...
res = odil_lbfgs(problem; max_iterations = 50000, callback_set = callback_set)
write_vtk(problem, res, "odil_1d_advection_lbfgs")
...
write_vtk(problem, res, "odil_1d_advection_lbfgs_errors")
