...
res = odil_timestepping(problem, odil_gauss_newton, "odil_2d_blast_wave_gauss_newton"; t_chunk_size = 4, max_iterations_per_chunk = 2000, callback_set = callback_set, sub_solver_info_prints = true)
