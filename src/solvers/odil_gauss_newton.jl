...
function odil_gauss_newton(lhs, rhs, p_lhs, p_rhs, u_iter0_size, u_fixed_vals, x_fixed_indicies, t_fixed_indicies, t; max_iterations = 2, extra = nothing,  p_extra = nothing, u_iter0 = nothing)
