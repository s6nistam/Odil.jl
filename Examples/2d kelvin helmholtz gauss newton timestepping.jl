using Odil
include("./trixi/tree_2d_dgsem/elixir_euler_kelvin_helmholtz_instability_adaptive_vol_int.jl")
...
res = odil_timestepping(problem, odil_gauss_newton, "odil_2d_kelvin_helmholtz_gauss_newton"; t_chunk_size = 8, max_iterations = 20)
