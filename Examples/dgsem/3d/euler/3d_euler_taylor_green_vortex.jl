...
res = odil_timestepping(problem, odil_gauss_newton, "odil_3d_euler_taylor_green_vortex"; t_chunk_size = 4, max_iterations_per_chunk = 200, callback_set = callback_set)
# res = odil_gauss_newton(problem; max_iterations = 10, callback_set = callback_set)

plot(problem, u_exact, res)

write_vtk(problem, res, "odil_3d_euler_taylor_green_vortex")