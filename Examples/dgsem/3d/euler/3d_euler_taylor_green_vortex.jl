...
res = odil_timestepping(problem, odil_gauss_newton, "odil_3d_euler_taylor_green_vortex_gauss_newton"; t_chunk_size = 4, max_iterations_per_chunk = 200, callback_set = callback_set)
