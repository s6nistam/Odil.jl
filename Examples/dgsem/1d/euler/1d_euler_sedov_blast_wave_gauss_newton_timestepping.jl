...
res = odil_timestepping(problem, odil_gauss_newton, "odil_1d_euler_sedov_blast_wave_gauss_newton"; t_chunk_size = 4, max_iterations = 200)

plot(problem, u_exact, res)

write_vtk(problem, res, "odil_1d_euler_sedov_blast_wave_gauss_newton")