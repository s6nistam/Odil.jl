...
res = odil_timestepping(problem, odil_gauss_newton, "odil_2d_vortex"; t_chunk_size = 8, max_iterations_per_chunk = 20, callback_set = callback_set)
# res = reconstruct_solution_from_chunks(problem, "odil_2d_vortex_gauss_newton"; t_chunk_size = 8)
write_vtk(problem, res, "odil_2d_vortex")
