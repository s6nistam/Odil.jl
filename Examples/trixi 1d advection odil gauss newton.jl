...
dt = t[2] - t[1]
bdf_weights = precompute_bdf_weights(2)  # Beispiel für BDF-Ordnung 4
p_lhs = (dt, x, t, bdf_weights)


sol = odil_gauss_newton(lhs!, ode.f, p_lhs, ode.p, size(ode.u0), ode.u0, eachindex(ode.u0), [1 for _ in eachindex(ode.u0)], Nt; max_iterations = 1000)
